...
export default function OurFamilies() {
    return (
        <Box pt={3} sx={{ background: 'linear-gradient(#E7F0FF, #E8F1FF)' }}>
            <Container  >
                <Grid container alignItems='center' spacing={{xs:2,md:2}} sx={{textAlign:"start"}}>

                    <Grid item xs={12} md={6} sx={{width:"575px"}}>
                        <Typography
                            fontWeight={600}
                            color="primary.main"
                        >
                        ...
                        <Typography color='#77829D' lineHeight={1.8} sx={{overflowWrap:"break-word"}}>
